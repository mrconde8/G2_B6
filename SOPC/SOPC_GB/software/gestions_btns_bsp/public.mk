...
JDI_FILE := D:/Documents/M2-SME/BE_VHDL/Git/G2_B6/SOPC/SOPC_GB/gestion_boutons.jdi
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x11018
SOPC_SYSID_FLAG += --sidp=0x11018
ELF_PATCH_FLAG  += --sidp 0x11018

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1609008448
SOPC_SYSID_FLAG += --timestamp=1609008448
ELF_PATCH_FLAG  += --timestamp 1609008448
