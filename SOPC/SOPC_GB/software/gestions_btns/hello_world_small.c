...
#define rst_n ( unsigned int *) AVALON_GESTION_0_BASE
#define Code_fonction ( unsigned int *) (AVALON_GESTION_0_BASE +4)
#define etat ( unsigned int *) (AVALON_GESTION_0_BASE +8)
//#define leds (unsigned int *) LEDS_BASE
